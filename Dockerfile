# Dockerfile (versão corrigida para instalação do Chrome no Render)

# Usar uma imagem base do Python que seja Debian-based (Buster é uma boa escolha)
FROM python:3.11-slim-buster

# Define o diretório de trabalho
WORKDIR /app

# --- NOVO: Instala o Google Chrome e o ChromeDriver (Método Moderno) ---
