-- Template BIWEB (schema public) — estrutura sem dados (modelo Windows).
-- Usado ao gerar link BI no painel (provision_bi_tenant).
-- Regenerar: python scripts/export_biweb_schema_template.py
