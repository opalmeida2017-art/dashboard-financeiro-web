...
<head>
<meta charset="utf-8">
<title>Relatório do Painel do Robô</title>
<style>
@page {{
    size: A4 landscape;
    margin: 10mm;
...
<h1>Relatório do Painel do Robô</h1>
...
<table>
    ...
    caminho = Path(tempfile.gettempdir()) / (
        f"relatorio_painel_robo_{_sufixo_arquivo()}.html"
    )
...
def salvar_relatorio_excel(filtros, cabecalhos, linhas, caminho_saida=None):
    ...
    larguras = {
        1: 20, 2: 12, 3: 14, 4: 28, 5: 12, 6: 14, 7: 14, 8: 12,
        9: 28, 10: 10, 11: 16, 12: 32, 13: 34, 14: 12, 15: 12,
    }
