"""versions/1_cria_a_estrutura_unificada_e_correta_do_.py
...
"""Cria as tabelas de sistema (apartamentos, usuarios, etc)
...
def upgrade() -> None:
    print("--- INICIANDO CRIAÇÃO DAS TABELAS DE SISTEMA ---")
    ...
    if not inspector.has_table('apartamentos'):
        ...
        op.create_table('apartamentos',
            ...
            # --- INÍCIO DA ALTERAÇÃO ---
            sa.Column('slug', sa.Text(), nullable=True, unique=True), # <-- COLUNA ADICIONADA
            # --- FIM DA ALTERAÇÃO ---
