"""3_Cria_a_estrutura_unificada_e_correta_do_banco_de_dados
...
def upgrade() -> None:
    ...
    if not inspector.has_table('relFilDespesasGerais'):
        print("-> Criando tabela 'relFilDespesasGerais'...")
        op.create_table('relFilDespesasGerais',
            ...
            sa.Column('dataAcertoProp', sa.Text(), nullable=True),
            sa.Column('dataControle', sa.Text(), nullable=True),
            sa.Column('dataControleFormat', sa.Text(), nullable=True),
            sa.Column('dataEmissao', sa.Text(), nullable=True),
            sa.Column('dataFim', sa.Text(), nullable=True),
            sa.Column('dataFimOficina', sa.Text(), nullable=True),
            sa.Column('dataINS', sa.Text(), nullable=True),
            sa.Column('dataIniOficina', sa.Text(), nullable=True),
            sa.Column('dataMotorista', sa.Text(), nullable=True),
            sa.Column('dataVenc', sa.Text(), nullable=True),
            sa.Column('dataVencimento', sa.Text(), nullable=True),
            ...
            sa.Column('mediaInversa', sa.REAL(), nullable=True),
            ...
            sa.Column('tempoPrevisto', sa.REAL(), nullable=True),
        ...
        print("-> Tabela 'relFilDespesasGerais' já existe. Pulando.")
