...
if __name__ == "__main__":
    ...
    # use_reloader=False evita carregar rembg/weasyprint duas vezes e deixa o dev mais rápido
    use_reload = os.environ.get("BIWEB_USE_RELOADER", "").strip().lower() in ("1", "true", "yes")
